...
def demonstrate_wisdom_accumulation():
    ...
    print(f"Query 1 (repeated): {query_1_repeat_cycles} cycles, Quality={query_1_repeat_quality:.2f}")
    
    print(f"\nKey Observations:")
    print(f"  1. Query 1 → Query 2: Different questions, both require full reasoning")
    print(f"  2. Query 1 (repeat): Same question, but wisdom was accumulated")
